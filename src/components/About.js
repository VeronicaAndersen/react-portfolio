const bio1 = "Systemutvecklare med hög prestation och 3,5 års erfarenhet inom utvecklingsbranschen. Min noggrannhet och fokus på slutanvändaren har gjort mig till en ovärderlig tillgång för mitt team. Jag drivs av viljan att leverera exceptionellt arbete och ha en betydande påverkan på de runt omkring mig.";
const bio2 = "Att samarbeta med både mitt team och externa intressenter för att lösa utmanande problem och hitta innovativa lösningar är en verklig passion för mig. Min förmåga att knyta kontakt med andra har varit avgörande för min karriärframgång. Jag har arbetat i hela utvecklingskedjan, från komplexa SQL-lösningar och vidareutveckling av system enligt SAFe, till moderna React-applikationer och support/felsökning i produktionsmiljö. Bland annat har jag framgångsrikt hanterat tjänstemigrationer, inklusive övergång från lokala lösningar till Microsoft 365, vilket har resulterat i ökad effektivitet och skalbarhet för kundernas system.";
const skills = "JavaScript, C#, React, TypeScript, T-SQL, ASP.NET, Tailwind CSS, Figma, Azure DevOps, Git";
